...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({ children, itemClassName = '' }) => (
  <div
    className={`scroll-stack-card relative w-full min-h-[22rem] h-auto my-8 p-8 rounded-2xl shadow-lg box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
