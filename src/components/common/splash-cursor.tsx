...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      if (!isWebGL2) glCtx = (canvasEl.getContext('webgl', params) || canvasEl.getContext('experimental-webgl', params)) as WebGLRenderingContext | null;
      ...
      if (isWebGL2) {
        ...
        supportLinearFiltering = (glCtx as WebGLRenderingContext).getExtension('OES_texture_half_float_linear');
      }
      (glCtx as WebGLRenderingContext).clearColor(0.0, 0.0, 0.0, 1.0);
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(glCtx as WebGL2RenderingContext, (glCtx as WebGL2RenderingContext).RGBA16F, (glCtx as WebGL2RenderingContext).RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(glCtx as WebGL2RenderingContext, (glCtx as WebGL2RenderingContext).RG16F, (glCtx as WebGL2RenderingContext).RG, halfFloatTexType);
        formatR = getSupportedFormat(glCtx as WebGL2RenderingContext, (glCtx as WebGL2RenderingContext).R16F, (glCtx as WebGL2RenderingContext).RED, halfFloatTexType);
      } else {
        formatRGBA = getSupportedFormat(glCtx as WebGLRenderingContext, (glCtx as WebGLRenderingContext).RGBA, (glCtx as WebGLRenderingContext).RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(glCtx as WebGLRenderingContext, (glCtx as WebGLRenderingContext).RGBA, (glCtx as WebGLRenderingContext).RGBA, halfFloatTexType);
        formatR = getSupportedFormat(glCtx as WebGLRenderingContext, (glCtx as WebGLRenderingContext).RGBA, (glCtx as WebGLRenderingContext).RGBA, halfFloatTexType);
      }

      return {
        gl: glCtx as WebGLRenderingContext & WebGL2RenderingContext,
        ext: {
          formatRGBA,
          formatRG,
          formatR,
    ...
    class Material {
      ...
      constructor(vertexShader: WebGLShader, fragmentShaderSource: string) {
        ...
        this.programs = {} as Record<number, WebGLProgram>;
    ...
    const blit = (() => {
      ...
      return (target: any, clear = false) => {
        if (target == null) {
          gl.viewport(0, 0, (gl as any).drawingBufferWidth, (gl as any).drawingBufferHeight);
